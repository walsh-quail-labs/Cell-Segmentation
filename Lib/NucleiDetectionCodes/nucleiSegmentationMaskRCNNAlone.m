function allSegBoundaries=nucleiSegmentationMaskRCNNAlone(result,WindowSize)



result = im2double(result);
% result = real(result.^1.4);
WindowSize = size(result);
...
%         end
        ...
        curSegBoundaries = adjust_boundaries(curPathBoundaries,0,0,inputSize,edge_sx,edge_sy,edge_ex,edge_ey);
