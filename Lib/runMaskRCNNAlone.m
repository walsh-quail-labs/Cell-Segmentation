...
clc;
addpath(genpath('Lib'))
config_file_path = 'config_paper_results.csv';
...
%     try
        ...
        WindowSize = 400;
        [Boundaries,nucleiImage,occupancy_image,nucleiOccupancyIndexed]=compute_nuclei_MaskRCNNalone(fileName,WindowSize);        
